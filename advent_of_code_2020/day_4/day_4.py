...
# Put the parsed passport into a more usable format
...
# Checks that all the default fields are included in each passport
...
# Checks that the fields include valid data
...
# Remove cm or in from the height and check if they are in desired range
...
#assert not(is_valid2(passport) for passport in INVALID)
#assert all(is_valid2(passport) for passport in VALID)

with open('/Users/thomaswileman/advent_of_code/advent_of_code_2020/day_4/input.txt') as f:
